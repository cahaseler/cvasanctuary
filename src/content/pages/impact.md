...
programs:
  ...
  conclusion: "We hope to expand our programs in 2021. Although times are uncertain, what remains consistent is the need for animal welfare in Stevens County. If you're interested in participating in any of our programs, information can be found on our Programs page."
  clinic_title: "Vaccine & Microchip Clinic"
  clinic_subtitle: "Households/Animals helped 2017-2020"
  charts:
...
moving_forward:
  title: "Moving Forward - How Can You help us help them?"
  items:
    - label: "Adopt"
      text: "all pets come altered, up to date on shots, de-wormed, microchipped."
    - label: "Foster"
      text: "take in an animal with needs or a litter of kittens to be trained and socialized."
    - label: "Volunteer"
      text: "give some of your time to clean, do yard work, remodel, socialize, office help. Many volunteers do a 2hr shift."
    - label: "Donate"
      text: "help financially with a one-time, recurring, round-up, bequest, AmazonSmile or purchase needed items. Visit our donation page or see our wish lists on Chewy and Amazon."
    - label: "Sponsor"
      text: "a project financially only or funding and completing the project also. Want some ideas? CVAS needs a new heating stove in main building, decking w/wheelchair ramp, gravel, concrete, yard beautification. .. the list goes on."
    - label: "Share CVAS"
      text: "join us on Facebook, our email newsletters, then share with your family and friends."
  image:
